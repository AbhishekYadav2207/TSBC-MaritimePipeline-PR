...
flowchart TD
    ...
    subgraph Outputs ["Final Corpus Artifacts"]
        ...
        CorpusTXT["outputs/stage-08/maritime_corpus.txt"]
        CorpusJSONL["outputs/stage-08/maritime_corpus.jsonl"]
        ManifestJSON["outputs/stage-08/manifest.json"]
    end
...
### 2.3 Output Schema Specification: `outputs/stage-07/clean_documents.jsonl`
...
- **Storage Location**: `outputs/stage-07/clean_documents.jsonl`
...
#### 1. `outputs/stage-08/maritime_corpus.txt`
...
- **Storage Location**: `outputs/stage-08/maritime_corpus.txt`
- **Format**: Plain Text UTF-8

---

#### 2. `outputs/stage-08/maritime_corpus.jsonl`
- **Created By**: `scripts/08_export_corpus.py`
...
- **Storage Location**: `outputs/stage-08/maritime_corpus.jsonl`
- **Format**: JSON Lines UTF-8

---

#### 3. `outputs/stage-08/manifest.json`
- **Created By**: `scripts/08_export_corpus.py`
...
- **Storage Location**: `outputs/stage-08/manifest.json`
- **Format**: JSON UTF-8
...
4. **Tightly Coupled Functions**:
   - `08_export_corpus.py` reads directly from `outputs/stage-07/clean_documents.jsonl` generated by Stage 07.
